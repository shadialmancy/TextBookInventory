...
public class AddEmployee extends AppCompatActivity {
    ArrayList<AdapterEmployee> listnewsData = new ArrayList<AdapterEmployee>();
    ...
    void LoadAllElement(){
        cursor=dbManagerUser.querySeller(null,null,null,null);
        ...
        if(cursor.moveToFirst())
            do{
                ...
                listnewsData.add(new AdapterEmployee(cursor.getString(0),cursor.getString(1),
    ...
    public void buAdd(View view) {
        ...
        long id=dbManagerUser.insertSeller(values);
        if(id>0)
            Toast.makeText(getApplicationContext(),"Seller is added and book id is:"+id,Toast.LENGTH_LONG).show();
        else
    ...
    public void buUpdate(View view) {
        ...
        dbManagerUser.UpdateSeller(values,"ID=?",SeletectionArgs);
        LoadAllElement();
    }
    ...
    public void buSearch(View view) {
        ...
        cursor=dbManagerUser.querySeller(null,"(ID like ?) OR (UserName like ?) OR (Name like ?)",SelectionArgs,null);
        listnewsData.clear();
        if(cursor.moveToFirst())
            do{
    ...
    public void buDelete(View view) {
        ...
        int count = dbManagerUser.DeleteSeller("ID=?",SeletectionArgs);
        if(count > 0)
            LoadAllElement();
    ...
    private class MyCustomAdapter extends BaseAdapter {
        public ArrayList<AdapterEmployee> listnewsDataAdpater;

        public MyCustomAdapter(ArrayList<AdapterEmployee> listnewsDataAdpater) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            View myView = mInflater.inflate(R.layout.listviewforemployee, null);

            final AdapterEmployee s = listnewsDataAdpater.get(position);
